            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(7,1fr)", gap: 9, marginBottom: 20 }}>
                {(dashboardStatsLoading || !dashboardStats)
                  ...
                  { label: "Reopened", value: dashboardStats.reopened, bg: "#fff7ed", accent: "#f97316", icon: "", action: () => { const dateFrom = getDateFrom(); switchView("tickets"); setTvFilter("reopened"); setFilterStatus([]); setPriorityF("All"); setTicketDateFrom(dateFrom); } },
                ].map(s => (
